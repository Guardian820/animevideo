 ...
 */
class Version20140323140812 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql("CREATE TABLE anime (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, year INT NOT NULL, episodes INT NOT NULL, genre LONGTEXT NOT NULL COMMENT '(DC2Type:array)', description LONGTEXT NOT NULL, view_count INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB");
